...
async function load(module, imports) {
    const module2 = await fetch('./polkadot_cli_bg.wasm');
    console.log('module, imports', module2, imports)
    if (typeof Response === 'function' && module2 instanceof Response) {
        console.log('you is function?')
        ...
        console.log('You is no function')
...
//     fetch('polkadot_cli_bg.wasm').then(response => {
//         console.log('FETCH RESOMSE')
...
//     // import("./polkadot_cli_bg.wasm").then( instance => {
...
function init() {
    ...
    fetch('./node_modules/connect/dist/clients/polkadot/polkadot_cli_bg.wasm').then(response => {
        console.log('FETCH RESOMSE', response)
        // return response.arrayBuffer()
    }).then(bytes => {
    // WebAssembly.instantiate(bytes, importObject)
        return bytes
