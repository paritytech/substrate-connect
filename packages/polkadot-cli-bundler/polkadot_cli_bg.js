...
import * as wasm from './polkadot_cli_bg.wasm';
...
export const __wbg_client_new = function(arg0) {
...
export const __wbg_indexedDB_7cf65ef1f512aaa7 = handleError(function(arg0) {
    var ret = getObject(arg0).indexedDB;
    return isLikeNone(ret) ? 0 : addHeapObject(ret);
});

export const __wbg_clearTimeout_76fc7acc04019bac = function(arg0, arg1) {
...
export const __wbg_debug_b1dc198008810ba0 = function(arg0) {
...
export const __wbg_info_0e6ed2caec2b6177 = function(arg0) {
...
export const __wbg_warn_381332f6edb6676a = function(arg0) {
    console.warn(getObject(arg0));
};

export const __wbg_value_48cf43d597443117 = handleError(function(arg0) {
    var ret = getObject(arg0).value;
    return addHeapObject(ret);
});

export const __wbg_instanceof_IdbRequest_2a4c4012cba50c94 = function(arg0) {
    var ret = getObject(arg0) instanceof IDBRequest;
    return ret;
};

export const __wbg_result_a0844c824c55f688 = handleError(function(arg0) {
    var ret = getObject(arg0).result;
    return addHeapObject(ret);
});

export const __wbg_setonsuccess_b47441069cea719b = function(arg0, arg1) {
    getObject(arg0).onsuccess = getObject(arg1);
};

export const __wbg_key_a65ef6f13b92c5bf = handleError(function(arg0) {
    var ret = getObject(arg0).key;
    return addHeapObject(ret);
});

export const __wbg_continue_8db8af658d7fc010 = handleError(function(arg0) {
    getObject(arg0).continue();
});

export const __wbg_setoncomplete_2940f4a3e5101235 = function(arg0, arg1) {
    getObject(arg0).oncomplete = getObject(arg1);
};

export const __wbg_setonerror_e966175e65369e53 = function(arg0, arg1) {
    getObject(arg0).onerror = getObject(arg1);
};

export const __wbg_objectStore_dc4b15d7f8979094 = handleError(function(arg0, arg1, arg2) {
    var ret = getObject(arg0).objectStore(getStringFromWasm0(arg1, arg2));
    return addHeapObject(ret);
});

export const __wbg_length_129fe6e0a32bc303 = function(arg0) {
    var ret = getObject(arg0).length;
    return ret;
};

export const __wbg_setonupgradeneeded_d4bb9f4c3894e5fd = function(arg0, arg1) {
    getObject(arg0).onupgradeneeded = getObject(arg1);
};

export const __wbg_clearTimeout_69b2e83e462d2565 = function(arg0, arg1) {
    getObject(arg0).clearTimeout(arg1);
};

export const __wbg_setTimeout_30909e88654920d5 = handleError(function(arg0, arg1, arg2) {
    var ret = getObject(arg0).setTimeout(getObject(arg1), arg2);
    return ret;
});

export const __wbg_delete_9c5723da3f13f180 = handleError(function(arg0, arg1) {
    var ret = getObject(arg0).delete(getObject(arg1));
    return addHeapObject(ret);
});

export const __wbg_openCursor_023c04de1ed61dce = handleError(function(arg0) {
    var ret = getObject(arg0).openCursor();
    return addHeapObject(ret);
});

export const __wbg_put_34d0b26820180a8e = handleError(function(arg0, arg1, arg2) {
    var ret = getObject(arg0).put(getObject(arg1), getObject(arg2));
    return addHeapObject(ret);
});

export const __wbg_instanceof_IdbDatabase_e4582a52a8740df5 = function(arg0) {
    var ret = getObject(arg0) instanceof IDBDatabase;
    return ret;
};

export const __wbg_version_81c9fe6417179dab = function(arg0) {
    var ret = getObject(arg0).version;
    return ret;
};

export const __wbg_objectStoreNames_547aa6a1412af172 = function(arg0) {
    var ret = getObject(arg0).objectStoreNames;
    return addHeapObject(ret);
};

export const __wbg_close_c70b934162a785ba = function(arg0) {
    getObject(arg0).close();
};

export const __wbg_createObjectStore_263bfc197cd2839e = handleError(function(arg0, arg1, arg2) {
    var ret = getObject(arg0).createObjectStore(getStringFromWasm0(arg1, arg2));
    return addHeapObject(ret);
});

export const __wbg_transaction_e7521034eeb58639 = handleError(function(arg0, arg1, arg2) {
    var ret = getObject(arg0).transaction(getStringFromWasm0(arg1, arg2));
    return addHeapObject(ret);
});

export const __wbg_transaction_20c71713ec7bbb12 = handleError(function(arg0, arg1, arg2) {
...
export const __wbg_open_dfd21f680a4b21db = handleError(function(arg0, arg1, arg2, arg3) {
    var ret = getObject(arg0).open(getStringFromWasm0(arg1, arg2), arg3 >>> 0);
    return addHeapObject(ret);
});

export const __wbg_open_1c0c887e5b23b879 = handleError(function(arg0, arg1, arg2) {
    var ret = getObject(arg0).open(getStringFromWasm0(arg1, arg2));
    return addHeapObject(ret);
});

export const __wbg_bound_affd21816afd0239 = handleError(function(arg0, arg1) {
    var ret = IDBKeyRange.bound(getObject(arg0), getObject(arg1));
    return addHeapObject(ret);
});

export const __wbg_target_198c16eb4b6da88a = function(arg0) {
...
export const __wbg_byteLength_996c5eddfef844a1 = function(arg0) {
...
export const __wbg_getTime_f2e21daa8c24da42 = function(arg0) {
    var ret = getObject(arg0).getTime();
    return ret;
};

export const __wbg_getTimezoneOffset_4d436b2cbd2219c6 = function(arg0) {
    var ret = getObject(arg0).getTimezoneOffset();
    return ret;
};

export const __wbg_new0_37b6dafc4af0031b = function() {
    var ret = new Date();
    return addHeapObject(ret);
};
...
export const __wbg_byteLength_8ccaaa08f5fe2b51 = function(arg0) {
    var ret = getObject(arg0).byteLength;
    return ret;
};
...
export const __wbindgen_closure_wrapper13593 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 3531, __wbg_adapter_24);
    return addHeapObject(ret);
};

export const __wbindgen_closure_wrapper13594 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 3531, __wbg_adapter_33);
    return addHeapObject(ret);
};

export const __wbindgen_closure_wrapper20964 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 5977, __wbg_adapter_30);
    return addHeapObject(ret);
};

export const __wbindgen_closure_wrapper20161 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 5664, __wbg_adapter_36);
    return addHeapObject(ret);
};

export const __wbindgen_closure_wrapper21244 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 6091, __wbg_adapter_27);
    return addHeapObject(ret);
};
