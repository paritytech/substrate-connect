...
- 7056aef: chore(deps-dev): bump vite in the npm_and_yarn group
  ...
  ***
  ...
  - @substrate/light-client-extension-helpers@2.7.7
  - @substrate/smoldot-discovery-connector@0.3.12
...
- Updated dependencies [66eae37]
  ...
  - @substrate/smoldot-discovery-connector@0.3.10
...
- Updated dependencies [65ebf4d]
  ...
  - @substrate/smoldot-discovery-connector@0.3.9
...
- ae70d90: chore: update chainspecs
  ...
  - @substrate/smoldot-discovery-connector@0.3.8
...
- 5a33922: chore(deps-dev): bump concurrently from 8.2.2 to 9.1.2
...
- 6de41a0: chore(deps): bump tailwind-merge from 2.4.0 to 3.0.1
...
- 96e6189: chore(deps): bump the polkadot-api group across 1 directory with 7 updates
  ...
  | [polkadot-api](https://github.com/polkadot-api/polkadot-api)                         | `1.8.2`   | `1.9.0`  |
  ...
  Updates `polkadot-api` from 1.8.2 to 1.9.0

  - [Release notes](https://github.com/polkadot-api/polkadot-api/releases)
  - [Changelog](https://github.com/polkadot-api/polkadot-api/blob/main/NEWS.md)
  - [Commits](https://github.com/polkadot-api/polkadot-api/compare/polkadot-api@1.8.2...polkadot-api@1.9.0)
...
- b425055: chore(deps): bump the pjs group across 1 directory with 8 updates
...
- 6cfce59: chore(deps): bump the polkadot-labs group with 3 updates
...
- 1ffa07a: chore(deps): bump the pjs group with 2 updates
...
- 0cd7d41: chore(deps): bump the radix-ui group with 27 updates
...
- 544e63e: chore(deps-dev): bump vite-plugin-web-extension from 4.2.0 to 4.4.3
...
- Updated dependencies [92316c0]
  ...
  - @substrate/smoldot-discovery-connector@0.3.7
...
- 05811c9: chore(deps): bump the pjs group across 1 directory with 9 updates
...
- c3074e3: chore(deps): bump embla-carousel-react from 8.1.3 to 8.3.0
...
- c5add59: chore(deps-dev): bump vite from 5.3.6 to 5.4.10
...
- c271bbe: chore(deps): bump the pjs group across 1 directory with 9 updates
...
- de98edc: chore(deps): bump the pjs group across 1 directory with 6 updates
...
- 0467f6b: chore(deps): bump the polkadot-api group with 8 updates
...
- f3c4ae6: chore(deps): bump date-fns from 3.6.0 to 4.1.0
...
- 4478658: chore(deps): bump @hookform/resolvers from 3.9.0 to 3.9.1
...
- 869cca5: chore(deps-dev): bump @playwright/test from 1.44.1 to 1.48.2
...
- 6988766: chore(deps): bump next-themes from 0.3.0 to 0.4.1
...
- a8dcac5: chore(deps): bump react-resizable-panels from 2.0.19 to 2.1.6
...
- 2536bd0: chore(deps): bump @polkadot-labs/hdkd in the polkadot-labs group
...
- c9ea319: chore(deps): bump react-router-dom from 6.25.1 to 6.27.0
...
- 3686203: chore(deps-dev): bump @vitejs/plugin-react-swc from 3.7.0 to 3.7.1
...
- 0203ecd: chore(deps): bump @polkadot-labs/hdkd-helpers from 0.0.6 to 0.0.8
...
- 0576805: chore(deps): bump @polkadot-api/substrate-bindings from 0.5.0 to 0.6.0
...
- 206c4a5: chore(deps): bump @radix-ui/react-alert-dialog from 1.0.5 to 1.1.1
...
- c0effcb: chore(deps): bump @polkadot-api/view-builder from 0.2.0 to 0.2.1
