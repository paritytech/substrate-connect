...
const ClientMenu: React.FunctionComponent<Network | Parachain> = ({
  name,
  ...props
}) => {
...
const ClientItem: React.FunctionComponent<Network | Parachain> = ({
  ...props
}) => {
  const classes = useStyles()
  ...
  return (
    <Grid
      container
      className={`${classes.root} ${isParachain ? "parachain" : ""}`}
    >
