...
- Fix a bug that was not saving the databaseContent of each chain in the extension's localStorage upon first initialization of the extension. ([#1025](https://github.com/paritytech/substrate-connect/pull/1025))
