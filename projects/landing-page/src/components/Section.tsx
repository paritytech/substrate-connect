...
const useStyles = makeStyles((theme) => ({
  section: {
    ...
    "&:after": {
      ...
      position: "absolute",
      top: 0,
      left: `calc(${theme.breakpoints.values.lg / 2}px - 50vw - ${theme.spacing(
        5,
      )}px)`,
      height: "100%",
      width: "100vw",
...
export const SectionHeading: React.FunctionComponent<HeadingProps> = ({
  children,
  prefix,
  id,
}) => {
...
export const SectionRef: React.FunctionComponent<ButtonProps> = ({
  ...
  return (
    <a target="_blank" rel="noreferrer" href={href} className={classes.ref}>
      <Button color="secondary" startIcon={startIcon} {...props}>
        {children}
      </Button>
    </a>
  )
