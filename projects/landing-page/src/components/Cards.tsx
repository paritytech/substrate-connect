...
export const CardProject: React.FunctionComponent<CardProjectProps> = ({
  children,
  title,
  subtitle,
  linkProps,
  ...
  return (
    <Grid
      ...
      style={imageProps?.fullWidth ? { width: "calc(100%)" } : {}}
    >
      ...
      <img
        src={imageProps?.path || ""}
        alt={title}
        style={{ objectPosition: imageProps?.position }}
      />
...
export const CardNetwork: React.FunctionComponent<CardNetworkProps> = ({
  children,
  title,
  statusProps,
  linkProps,
