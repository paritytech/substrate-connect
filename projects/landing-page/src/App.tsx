      ...
      <UIContainer>
        <div>
          ...
          <Section>
            ...
            <SectionText>
              A light client only verifies the authenticity of blocks, but not
              their correctness. For this reason, the block that is reported as
              being the best block might be incorrect. In the context of a light
              client, only the finalised block can be assumed to be correct.
              Consequently, accessing the storage of any non-finalised block is
              also not guaranteed to report correct values.
            </SectionText>
